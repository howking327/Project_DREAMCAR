...
def run(emo, my_tag):
    ...
    if emo == 'drowsy':
        ...
        total = random_tag(e, s, w, t, my_tag, emo)
...
def recommendtaion(sub_recom, data):
    ...
    if idx == 0:
        cos_tag = np.load(
            'C:/Users/YEO/PycharmProjects/Final_Project/arena_data/cos_tag_split/' + str(idx) + '_99' + '.npy')

    else:
        cos_tag = np.load(
            'C:/Users/YEO/PycharmProjects/Final_Project/arena_data/cos_tag_split/' + str(idx) + '00_' + str(
                idx) + '99' + '.npy')
...
# song_csv = "C:/Users/1-6/Desktop/melon-playlist-continuation/arena_data/song.csv"
# train_json = 'C:/Users/1-6/Desktop/melon-playlist-continuation/arena_data/data.json'
# ply_id, ply_cos, ply_title, ply_tag, song_list = main(song_csv, train_json, 'happy', 111101)
